...
# vggin = vgginnet_builder()
# vggin.compile(loss='categorical_crossentropy', 
#                         optimizer=tf.keras.optimizers.Adam(learning_rate=0.001), 
#                         metrics=[f1_score])
# vggin.fit(dataset("C:\\Users\\aleks\\Projects\\Tissues\\BreaKHis 400X\\train", train=True),
#             epochs=100,
#             validation_data=dataset("C:\\Users\\aleks\\Projects\\Tissues\\BreaKHis 400X\\test", train=False),
#             validation_freq=1,
#             callbacks=[alexnet.accuracy_callback()])
# vggin.save("idc_vggin_more_accurate")